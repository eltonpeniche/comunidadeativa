...
from .forms import ContatoForm, LoginForm, PostForm, RelatorioForm
...
def contato(request):
     if request.method =='GET':
          form = ContatoForm()
          return render(request, 'pages/contato/contato.html', {'form': form})
     if request.method =='POST':
          template_name = 'pages/contato/partials/_contato-form.html'
          ...
          if form.is_valid():
               form.save()
               form = ContatoForm()
               messages.success(request, 'Messagem enviada com sucesso')
